            ...
            <?php endif;?>
                                            <div class="card-header">
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">+ Add Campaign Image</button>
                                                <span>Click + Button to <code>add new campaign image </code> </span>
                                            </div>
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php $i=1;foreach ($campaign_images as $key): ?>
                                                                <tr>
                                                                    <td><?php echo $i; ?></td>
                                                                    ...
                                                                    <td><img src="<?php echo base_url().$key->image;?>" style="height:100px;width:120px;border-radius:10px;box-shadow:0 5px 10px rgba(0,0,0,0.4);"></td>
                                                                        <td><a href="<?php echo base_url('admin/editCampaignImage/'.$key->id); ?>">Edit</a></td>
                                                                        <td><a onclick="return confirm('Are you sure?');" href="<?php echo base_url('admin/deleteCampaignImage/'.$key->id); ?>">Delete</a></td>
                                                                </tr>
                                                            <?php $i++;endforeach ?>
                                                        </tbody>
                                                    </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Campaign Image</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?php echo base_url('admin/addCampaignImage');?>" method="post" enctype="multipart/form-data">
