                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                       ...
                                                       <?php foreach ($campaign as $key): ?>
                                                        <form method="post" action="<?php echo base_url('admin/updateCampaign/'.$key->id);?>" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    placeholder="Enter Campaign Sub Title" value="<?php echo $key->sub_title;?>">
                                                                </div>
                                                            </div>
