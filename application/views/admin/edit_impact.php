                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Update Impact Image</h5>
                                                        <!-- <span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span> -->
                                                    </div>
                                                    <div class="card-block">
                                                       <!--  <h4 class="sub-title">Basic Inputs</h4> -->
                                                       <?php foreach ($impact as $key): ?>
                                                        <form method="post" action="<?php echo base_url('admin/updateImpact/'.$key->id);?>" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group text-center">
                                                            	<input type="submit" class="btn btn-success" value="Update Impact Image"/>
                                                            </div>
                                                            </div>      
                                                                    </form>
                                                                    <?php endforeach ?>
