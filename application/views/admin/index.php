                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          ...
                                          <p class="m-b-0">Welcome to IPAC</p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url('assets/admin/');?>assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url('assets/admin/');?>assets/images/avatar-5.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url('assets/admin/');?>assets/images/avatar-3.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                                <h6>William Jem</h6>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url('assets/admin/');?>assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                                <h6>David Jones</h6>
                                                                                <p class="text-muted m-b-0">Developer</p>
                                                                            </div>
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="align-middle m-b-30">
                                                            <img src="<?php echo base_url('assets/admin/');?>assets/images/avatar-1.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <h6>David Jones</h6>
                                                                <p class="text-muted m-b-0">Developer</p>
                                                            </div>
