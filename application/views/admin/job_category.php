            ...
            <?php endif;?>
                                            <div class="card-header">
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">+ Add Job Category</button>
                                                <span>Click + Button to <code>add new job category </code> </span>
                                            </div>
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php $i=1;foreach ($join_category as $key): ?>
                                                                <tr>
                                                                    <td><?php echo $i; ?></td>
                                                                    <td><?php echo $key->cat_name; ?></td>
                                                                    <td><a  href="<?php echo base_url('admin/editJobCategory/'.$key->id); ?>">edit</a></td>
                                                                    <td><a onclick="return confirm('Are you sure?');" href="<?php echo base_url('admin/deleteJobCategory/'.$key->id); ?>">Delete</a></td>
                                                                </tr>
                                                            <?php $i++;endforeach ?>
                                                        </tbody>
                                                    </table>
