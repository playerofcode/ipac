...
<head>
    <title>IPAC - Admin Panel </title>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <meta name="description" content="IPAC Content Here" />
      ...
      <!-- Required Fremwork -->
      <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/');?>assets/css/bootstrap/css/bootstrap.min.css">
      <!-- waves.css -->
      <link rel="stylesheet" href="<?php echo base_url('assets/admin/');?>assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      <!-- themify-icons line icon -->
      <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/');?>assets/icon/themify-icons/themify-icons.css">
      <!-- ico font -->
      <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/');?>assets/icon/icofont/css/icofont.css">
      <!-- Font Awesome -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form action="<?php echo base_url('admin/authenticate');?>" method="post" class="md-float-material form-material">
                            <div class="text-center">
                                <img src="<?php echo base_url('assets/admin/');?>assets/images/logo.png" alt="logo.png">
                            </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <p class="text-inverse text-left"><a href="<?php echo base_url();?>"><b>Back to website</b></a></p>
                                        </div>
                                        <div class="col-md-2">
                                            <img src="<?php echo base_url('assets/admin/');?>assets/images/auth/Logo-small-bottom.png" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/admin/');?>assets/js/common-pages.js"></script>
</body>
</html>
