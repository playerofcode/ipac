        ...
        <div id="bootcarousel" class="carousel slide animate_text carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner text-light carousel-zoom">
                <div class="item active">
                    <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/banner/banner1.jpg);"></div>
                ...
                <div class="item">
                    <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/banner/banner2.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                ...
                <div class="item">
                    <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/banner/banner4.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                ...
                <div class="item">
                    <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/banner/banner5.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                ...
                <div class="item">
                    <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/banner/banner6.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                ...
                <div class="item">
                    <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/banner/banner3.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
            ...
            <div class="row">
                <div class="about-info">
                    <div class="col-md-6 thumb">
                        <img src="<?php echo base_url();?>assets/img/about.jpg" alt="Thumb">
                    </div>
            ...
            <div class="row">
                <div class="featured-courses-carousel owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="col-md-5">
                            <div class="thumb">
                                <img src="<?php echo base_url();?>assets/img/courses/f1.jpg" alt="Thumb">
                                <div class="live-view">
                    ...
                    <div class="item">
                        <div class="col-md-5">
                            <div class="thumb">
                                <img src="<?php echo base_url();?>assets/img/courses/f2.jpg" alt="Thumb">
                                <div class="live-view">
                    ...
                    <div class="item">
                        <div class="col-md-5">
                            <div class="thumb">
                                <img src="<?php echo base_url();?>assets/img/courses/f3.jpg" alt="Thumb">
                                <div class="live-view">
                ...
                <div class="col-md-12">
                    <div class="popular-courses-items popular-courses-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assets/img/courses/1.jpg" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?php echo base_url();?>assets/img/team/7.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assets/img/courses/2.jpg" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?php echo base_url();?>assets/img/team/8.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                                        <a href="#">Akua Paul</a>
                                        <div class="rating">
                        ...
                        <div class="item">
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?php echo base_url();?>assets/img/team/9.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                        ...
                        <div class="item">
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?php echo base_url();?>assets/img/team/2.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                                        <a href="#">Huma Park</a>
                                        <div class="rating">
                        ...
                        <div class="item">
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?php echo base_url();?>assets/img/team/3.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="advisor-items advisor-carousel-solid owl-carousel owl-theme text-center text-light">
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="<?php echo base_url();?>assets/img/advisor/5.jpg" alt="Thumb">  
                                <div class="info-title">
                                    <h4>Professon. John Doe</h4>
                                    <span>Senior Writter</span>
                                    <div class="social">
            ...
            <div class="row">
                <div class="event-items">
                    ...
                    <div class="item vertical col-md-6">
                        <div class="thumb">
                            <img src="<?php echo base_url();?>assets/img/event/2.jpg" alt="Thumb">
                            <div class="date">
                    ...
                    <div class="item vertical col-md-6">
                        <div class="thumb">
                            <img src="<?php echo base_url();?>assets/img/event/3.jpg" alt="Thumb">
                            <div class="date">
                    ...
                    <!-- Single Item -->
                    <div class="item horizontal col-md-12">
                        <div class="col-md-6 thumb bg-cover" style="background-image: url(assets/img/event/4.jpg);">
                            <div class="date">
        ...
        <div class="container">
            <div class="row">
                <div class="reg-items">
                    ...
                    <div class="col-md-6 thumb">
                        <img src="<?php echo base_url();?>assets/img/contact.png" alt="Thumb">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="clients-review-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="<?php echo base_url();?>assets/img/team/2.jpg" alt="Thumb">
                            </div>
                            <div class="col-md-7 info">
                                <p>
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="<?php echo base_url();?>assets/img/team/7.jpg" alt="Thumb">
                            </div>
                            <div class="col-md-7 info">
                                <p>
                                    Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
            ...
            <div class="row">
                <div class="blog-items">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="<?php echo base_url();?>assets/img/blog/1.jpg" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="<?php echo base_url();?>assets/img/blog/2.jpg" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="<?php echo base_url();?>assets/img/blog/3.jpg" alt="Thumb"></a>
                                <div class="date">
                ...
                <div class="col-md-8 clients">
                    <div class="clients-items owl-carousel owl-theme text-center">
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/1.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/2.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/3.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/4.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/5.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/6.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/7.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/8.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?php echo base_url();?>assets/img/clients/9.png" alt="Clients"></a>
                        </div>
                    </div>
                </div>
            </div>
